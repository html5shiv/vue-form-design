    ...
    <div>
        ...
        <dchPanel title="单行文本" >
            ...
            <div class="form-item">
                ...
                <div class="form-item-cont">
                    <InputNumber v-model="dataConfig.value" class="long" :max="dataConfig.max" :min="dataConfig.min" />
                </div>
            </div> <!-- form-item 结束 -->
            <div class="form-item">
                <div class="form-item-tit">
                ...
                <div class="form-item-cont">
                    <InputNumber v-model="dataConfig.max" class="long" />
                </div>
            </div> <!-- form-item 结束 -->
            <div class="form-item">
                <div class="form-item-tit">
                ...
                <div class="form-item-cont">
                    <InputNumber v-model="dataConfig.min" class="long" />
                </div>
            </div> <!-- form-item 结束 -->
            <div class="form-item">
                <div class="form-item-tit">
                ...
                <div class="form-item-cont">
                    <Input v-model="dataConfig.unit" placeholder="请输入单位"></Input>
                </div>
            </div> <!-- form-item 结束 -->
        </dchPanel>
    ...
    methods: {
        ...
        renderDom() {
            ...
            let opts = this.dataConfig,
                ...
                value = opts.value,
                // 输入框
                $input = $('<input v-if="isEdit" v-model="formObj.'+ opts.code +'" type="number" value="'+value+'">'),
                // 输入框宽度
            ...
            // 如果存在后面文字
            if(!M.isNull(opts.unit)) {
                $box.append('<span class="after-text">'+opts.unit+'</span>');
            }
            // 向父级组件提交改变dom的操作
